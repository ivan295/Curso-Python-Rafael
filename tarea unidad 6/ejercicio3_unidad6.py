"""
    Durante la planificación de un proyecto se han acordado una lista de
...
lista = ['6 Distribución', '2 Diseño', '1 Concepción',
         '7 Mantenimiento', '4 Producción', '3 Planificación', '5 Pruebas']
cola = deque(lista)
for dato in cola:
    dato = slice(0, 1)
    print(cola[dato])
